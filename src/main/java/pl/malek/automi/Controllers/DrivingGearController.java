...
public class DrivingGearController {
    ...
    @PostMapping("/")
    public ResponseEntity<DrivingGear> add(@Valid @RequestBody DrivingGear drivingGear, BindingResult result) throws DrivinGearCreationException {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DrivingGear> update(@PathVariable long id, @Valid @RequestBody DrivingGear drivingGear, BindingResult result) throws DrivinGearCreationException, DrivingGearNotFoundException {
